...
"""
    ...
    def join_between(
        ...
        """
        Perform a join by matching values from this table with an interval in another table.

        A row from this table may be included in zero or multiple rows in the resulting join,
        ...
        left_on = parse_into_expression(left_on)
        right_on_lower = parse_into_expression(right_on_lower)
        right_on_upper = parse_into_expression(right_on_upper)

        lower_expr = left_on > right_on_lower if exclusive_lower else left_on >= right_on_lower
        upper_expr = left_on < right_on_upper if exclusive_upper else left_on <= right_on_upper
